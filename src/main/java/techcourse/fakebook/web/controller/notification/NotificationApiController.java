...
public class NotificationApiController {
    ...
    public ResponseEntity<String> findAllByArticleId(@SessionUser UserOutline userOutline) {
        return ResponseEntity.ok().body(this.notificationService.issue(userOutline.getId()));
    }
}